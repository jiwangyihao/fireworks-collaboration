...
// GitHub 认证流程
// async function authenticateGitHub(): Promise<boolean> {
//   try {
//     // 首先检查是否已有有效的访问令牌
//     const existingToken = await loadAccessToken();
//     if (existingToken) {
//       const isValid = await validateToken(existingToken);
//       if (isValid) {
//         githubUser.value = await getUserInfo(existingToken);
...
//       type: "success",
//       message: `GitHub 认证成功，欢迎 ${userInfo.name || userInfo.login}！`,
//     };
//
//     return true;
//   } catch (error) {
