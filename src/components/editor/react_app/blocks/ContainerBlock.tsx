...
export const ContainerBlock = createReactBlockSpec(
  ...
  {
    render: (props) => <ContainerBlockContent {...props} />,
  }
);

export const ContainerBlockContent = (props: any) => {
  ...
  // Note: We need to register executor inside here too if we want logic to work,
  // or pass it down. But the logic uses props.editor/block.
  // Wait, I should move the ENTIRE logic into ContainerBlockContent
