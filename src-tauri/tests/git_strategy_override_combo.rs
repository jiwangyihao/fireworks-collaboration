...
fn strategy_override_combo() {
    ...
    rt.block_on(async {
        ...
        assert_applied_code(&id1.to_string(), "http_strategy_override_applied");
        assert_applied_code(&id1.to_string(), "retry_strategy_override_applied");
        ...
        assert_no_applied_code(&id2.to_string(), "http_strategy_override_applied");
        assert_applied_code(&id2.to_string(), "retry_strategy_override_applied");
        ...
        assert_no_applied_code(&id3.to_string(), "http_strategy_override_applied");
        assert_no_applied_code(&id3.to_string(), "retry_strategy_override_applied");
        ...
        assert_no_applied_code(&id4.to_string(), "http_strategy_override_applied");
        assert_no_applied_code(&id4.to_string(), "retry_strategy_override_applied");
    ...
    wait_task(&reg, id_c).await; hc.await.unwrap();
    ...
    let (id5, tk5) = reg.create(TaskKind::GitFetch { repo: src_path.clone(), dest: work5.path().to_string_lossy().to_string(), depth: None, filter: None, strategy_override: Some(ov5.clone()) });
        ...
        assert_applied_code(&id5.to_string(), "http_strategy_override_applied");
        assert_applied_code(&id5.to_string(), "retry_strategy_override_applied");
    ...
    wait_task(&reg, id6c).await; h6c.await.unwrap();
        ...
        assert_no_applied_code(&id6.to_string(), "http_strategy_override_applied");
        assert_applied_code(&id6.to_string(), "retry_strategy_override_applied");
    });
}
